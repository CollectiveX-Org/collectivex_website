  ...
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#4CEBBB] via-[#3EA0F4] to-[#4CEBBB]">
            Key Features
          </h2>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-[#1C2936]/80 backdrop-blur-xl p-6 rounded-xl border border-[#4CEBBB]/20 h-full">
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-[#4CEBBB]/0 to-[#3EA0F4]/0 group-hover:from-[#4CEBBB]/10 group-hover:to-[#3EA0F4]/10 transition-all duration-300 -z-10 blur-xl" />
